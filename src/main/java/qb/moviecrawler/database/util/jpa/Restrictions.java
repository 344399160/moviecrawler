package qb.moviecrawler.database.util.jpa;

import qb.moviecrawler.database.util.jpa.Criterion.MatchMode;
import qb.moviecrawler.database.util.jpa.Criterion.Operator;
